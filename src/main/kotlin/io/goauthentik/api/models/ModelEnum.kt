...
enum class ModelEnum(val value: kotlin.String) {
    ...
    @Json(name = "authentik_stages_authenticator_mobile.authenticatormobilestage")
    stagesAuthenticatorMobilePeriodAuthenticatormobilestage("authentik_stages_authenticator_mobile.authenticatormobilestage"),

    @Json(name = "authentik_stages_authenticator_mobile.mobiledevice")
    stagesAuthenticatorMobilePeriodMobiledevice("authentik_stages_authenticator_mobile.mobiledevice"),
    ...
    @Json(name = "authentik_brands.brand")
    ...
    @Json(name = "authentik_providers_rac.endpoint")
    providersRacPeriodEndpoint("authentik_providers_rac.endpoint"),

    @Json(name = "authentik_providers_rac.racpropertymapping")
