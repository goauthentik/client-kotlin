...
class CoreApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
     enum class IntentCoreTokensList(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun coreTokensList(description: kotlin.String? = null, expires: java.time.OffsetDateTime? = null, expiring: kotlin.Boolean? = null, identifier: kotlin.String? = null, intent: IntentCoreTokensList? = null, managed: kotlin.String? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, search: kotlin.String? = null, userUsername: kotlin.String? = null) : PaginatedTokenList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun coreTokensListWithHttpInfo(description: kotlin.String?, expires: java.time.OffsetDateTime?, expiring: kotlin.Boolean?, identifier: kotlin.String?, intent: IntentCoreTokensList?, managed: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, userUsername: kotlin.String?) : ApiResponse<PaginatedTokenList?> {
     ...
     * @return RequestConfig
     */
    fun coreTokensListRequestConfig(description: kotlin.String?, expires: java.time.OffsetDateTime?, expiring: kotlin.Boolean?, identifier: kotlin.String?, intent: IntentCoreTokensList?, managed: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, userUsername: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (description != null) {
                ...
                if (intent != null) {
                    put("intent", listOf(intent.value))
                }
                if (managed != null) {
     ...
     */
     enum class TypeCoreUsersList(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun coreUsersListWithHttpInfo(attributes: kotlin.String?, email: kotlin.String?, groupsByName: kotlin.collections.List<kotlin.String>?, groupsByPk: kotlin.collections.List<java.util.UUID>?, isActive: kotlin.Boolean?, isSuperuser: kotlin.Boolean?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, path: kotlin.String?, pathStartswith: kotlin.String?, search: kotlin.String?, type: kotlin.collections.List<TypeCoreUsersList>?, username: kotlin.String?, uuid: java.util.UUID?) : ApiResponse<PaginatedUserList?> {
     ...
     * @return RequestConfig
     */
    fun coreUsersListRequestConfig(attributes: kotlin.String?, email: kotlin.String?, groupsByName: kotlin.collections.List<kotlin.String>?, groupsByPk: kotlin.collections.List<java.util.UUID>?, isActive: kotlin.Boolean?, isSuperuser: kotlin.Boolean?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, path: kotlin.String?, pathStartswith: kotlin.String?, search: kotlin.String?, type: kotlin.collections.List<TypeCoreUsersList>?, username: kotlin.String?, uuid: java.util.UUID?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (attributes != null) {
