...
class RbacApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
     enum class ModelRbacPermissionsAssignedByRolesList(val value: kotlin.String) {
         ...
         @Json(name = "authentik_brands.brand") brandsPeriodBrand("authentik_brands.brand"),
         ...
         @Json(name = "authentik_providers_rac.endpoint") providersRacPeriodEndpoint("authentik_providers_rac.endpoint"),
         @Json(name = "authentik_providers_rac.racpropertymapping") providersRacPeriodRacpropertymapping("authentik_providers_rac.racpropertymapping"),
         @Json(name = "authentik_providers_rac.racprovider") providersRacPeriodRacprovider("authentik_providers_rac.racprovider"),
         ...
         @Json(name = "authentik_stages_authenticator_mobile.authenticatormobilestage") stagesAuthenticatorMobilePeriodAuthenticatormobilestage("authentik_stages_authenticator_mobile.authenticatormobilestage"),
         @Json(name = "authentik_stages_authenticator_mobile.mobiledevice") stagesAuthenticatorMobilePeriodMobiledevice("authentik_stages_authenticator_mobile.mobiledevice"),
         ...
         @Json(name = "authentik_tenants.domain") tenantsPeriodDomain("authentik_tenants.domain"),
     }
    ...
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun rbacPermissionsAssignedByRolesList(model: ModelRbacPermissionsAssignedByRolesList, objectPk: kotlin.String? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, search: kotlin.String? = null) : PaginatedRoleAssignedObjectPermissionList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun rbacPermissionsAssignedByRolesListWithHttpInfo(model: ModelRbacPermissionsAssignedByRolesList, objectPk: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?) : ApiResponse<PaginatedRoleAssignedObjectPermissionList?> {
     ...
     * @return RequestConfig
     */
    fun rbacPermissionsAssignedByRolesListRequestConfig(model: ModelRbacPermissionsAssignedByRolesList, objectPk: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?) : RequestConfig<Unit> {
     ...
     * enum for parameter model
     */
     enum class ModelRbacPermissionsAssignedByUsersList(val value: kotlin.String) {
         @Json(name = "authentik_blueprints.blueprintinstance") blueprintsPeriodBlueprintinstance("authentik_blueprints.blueprintinstance"),
         @Json(name = "authentik_brands.brand") brandsPeriodBrand("authentik_brands.brand"),
         @Json(name = "authentik_core.application") corePeriodApplication("authentik_core.application"),
         @Json(name = "authentik_core.group") corePeriodGroup("authentik_core.group"),
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun rbacPermissionsAssignedByUsersList(model: ModelRbacPermissionsAssignedByUsersList, objectPk: kotlin.String? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, search: kotlin.String? = null) : PaginatedUserAssignedObjectPermissionList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun rbacPermissionsAssignedByUsersListWithHttpInfo(model: ModelRbacPermissionsAssignedByUsersList, objectPk: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?) : ApiResponse<PaginatedUserAssignedObjectPermissionList?> {
     ...
     * @return RequestConfig
     */
    fun rbacPermissionsAssignedByUsersListRequestConfig(model: ModelRbacPermissionsAssignedByUsersList, objectPk: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("model", listOf(model.value))
