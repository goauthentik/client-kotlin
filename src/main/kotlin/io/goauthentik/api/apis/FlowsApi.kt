...
class FlowsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
     enum class InvalidResponseActionFlowsBindingsList(val value: kotlin.String) {
     ...
     */
     enum class PolicyEngineModeFlowsBindingsList(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun flowsBindingsList(evaluateOnPlan: kotlin.Boolean? = null, fsbUuid: java.util.UUID? = null, invalidResponseAction: InvalidResponseActionFlowsBindingsList? = null, order: kotlin.Int? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, pbmUuid: java.util.UUID? = null, policies: kotlin.collections.List<java.util.UUID>? = null, policyEngineMode: PolicyEngineModeFlowsBindingsList? = null, reEvaluatePolicies: kotlin.Boolean? = null, search: kotlin.String? = null, stage: java.util.UUID? = null, target: java.util.UUID? = null) : PaginatedFlowStageBindingList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun flowsBindingsListWithHttpInfo(evaluateOnPlan: kotlin.Boolean?, fsbUuid: java.util.UUID?, invalidResponseAction: InvalidResponseActionFlowsBindingsList?, order: kotlin.Int?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, pbmUuid: java.util.UUID?, policies: kotlin.collections.List<java.util.UUID>?, policyEngineMode: PolicyEngineModeFlowsBindingsList?, reEvaluatePolicies: kotlin.Boolean?, search: kotlin.String?, stage: java.util.UUID?, target: java.util.UUID?) : ApiResponse<PaginatedFlowStageBindingList?> {
     ...
     * @return RequestConfig
     */
    fun flowsBindingsListRequestConfig(evaluateOnPlan: kotlin.Boolean?, fsbUuid: java.util.UUID?, invalidResponseAction: InvalidResponseActionFlowsBindingsList?, order: kotlin.Int?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, pbmUuid: java.util.UUID?, policies: kotlin.collections.List<java.util.UUID>?, policyEngineMode: PolicyEngineModeFlowsBindingsList?, reEvaluatePolicies: kotlin.Boolean?, search: kotlin.String?, stage: java.util.UUID?, target: java.util.UUID?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                ...
                if (invalidResponseAction != null) {
                    put("invalid_response_action", listOf(invalidResponseAction.value))
                }
                if (order != null) {
     ...
     */
     enum class DeniedActionFlowsInstancesList(val value: kotlin.String) {
     ...
     */
     enum class DesignationFlowsInstancesList(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun flowsInstancesList(deniedAction: DeniedActionFlowsInstancesList? = null, designation: DesignationFlowsInstancesList? = null, flowUuid: java.util.UUID? = null, name: kotlin.String? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, search: kotlin.String? = null, slug: kotlin.String? = null) : PaginatedFlowList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun flowsInstancesListWithHttpInfo(deniedAction: DeniedActionFlowsInstancesList?, designation: DesignationFlowsInstancesList?, flowUuid: java.util.UUID?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, slug: kotlin.String?) : ApiResponse<PaginatedFlowList?> {
     ...
     * @return RequestConfig
     */
    fun flowsInstancesListRequestConfig(deniedAction: DeniedActionFlowsInstancesList?, designation: DesignationFlowsInstancesList?, flowUuid: java.util.UUID?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, slug: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (deniedAction != null) {
                    put("denied_action", listOf(deniedAction.value))
                }
                if (designation != null) {
                    put("designation", listOf(designation.value))
                }
                if (flowUuid != null) {
