...
class EventsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
     enum class Severity_eventsNotificationsList(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun eventsNotificationsList(body: kotlin.String? = null, created: java.time.OffsetDateTime? = null, event: java.util.UUID? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, search: kotlin.String? = null, seen: kotlin.Boolean? = null, severity: Severity_eventsNotificationsList? = null, user: kotlin.Int? = null) : PaginatedNotificationList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun eventsNotificationsListWithHttpInfo(body: kotlin.String?, created: java.time.OffsetDateTime?, event: java.util.UUID?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, seen: kotlin.Boolean?, severity: Severity_eventsNotificationsList?, user: kotlin.Int?) : ApiResponse<PaginatedNotificationList?> {
     ...
     * @return RequestConfig
     */
    fun eventsNotificationsListRequestConfig(body: kotlin.String?, created: java.time.OffsetDateTime?, event: java.util.UUID?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, seen: kotlin.Boolean?, severity: Severity_eventsNotificationsList?, user: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (body != null) {
     ...
     * enum for parameter severity
     */
     enum class Severity_eventsRulesList(val value: kotlin.String) {
         @Json(name = "alert") alert("alert"),
         @Json(name = "notice") notice("notice"),
         @Json(name = "warning") warning("warning"),
     }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun eventsRulesList(groupName: kotlin.String? = null, name: kotlin.String? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, search: kotlin.String? = null, severity: Severity_eventsRulesList? = null) : PaginatedNotificationRuleList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun eventsRulesListWithHttpInfo(groupName: kotlin.String?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, severity: Severity_eventsRulesList?) : ApiResponse<PaginatedNotificationRuleList?> {
     ...
     * @return RequestConfig
     */
    fun eventsRulesListRequestConfig(groupName: kotlin.String?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, severity: Severity_eventsRulesList?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (groupName != null) {
     ...
     */
     enum class Mode_eventsTransportsList(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun eventsTransportsList(mode: Mode_eventsTransportsList? = null, name: kotlin.String? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, search: kotlin.String? = null, sendOnce: kotlin.Boolean? = null, webhookUrl: kotlin.String? = null) : PaginatedNotificationTransportList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun eventsTransportsListWithHttpInfo(mode: Mode_eventsTransportsList?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, sendOnce: kotlin.Boolean?, webhookUrl: kotlin.String?) : ApiResponse<PaginatedNotificationTransportList?> {
     ...
     * @return RequestConfig
     */
    fun eventsTransportsListRequestConfig(mode: Mode_eventsTransportsList?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, search: kotlin.String?, sendOnce: kotlin.Boolean?, webhookUrl: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (mode != null) {
