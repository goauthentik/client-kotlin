...
class ProvidersApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
     enum class ClientType_providersOauth2List(val value: kotlin.String) {
     ...
     */
     enum class IssuerMode_providersOauth2List(val value: kotlin.String) {
     ...
     */
     enum class SubMode_providersOauth2List(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun providersOauth2List(accessCodeValidity: kotlin.String? = null, accessTokenValidity: kotlin.String? = null, application: java.util.UUID? = null, authorizationFlow: java.util.UUID? = null, clientId: kotlin.String? = null, clientType: ClientType_providersOauth2List? = null, includeClaimsInIdToken: kotlin.Boolean? = null, issuerMode: IssuerMode_providersOauth2List? = null, name: kotlin.String? = null, ordering: kotlin.String? = null, page: kotlin.Int? = null, pageSize: kotlin.Int? = null, propertyMappings: kotlin.collections.List<java.util.UUID>? = null, redirectUris: kotlin.String? = null, refreshTokenValidity: kotlin.String? = null, search: kotlin.String? = null, signingKey: java.util.UUID? = null, subMode: SubMode_providersOauth2List? = null) : PaginatedOAuth2ProviderList {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun providersOauth2ListWithHttpInfo(accessCodeValidity: kotlin.String?, accessTokenValidity: kotlin.String?, application: java.util.UUID?, authorizationFlow: java.util.UUID?, clientId: kotlin.String?, clientType: ClientType_providersOauth2List?, includeClaimsInIdToken: kotlin.Boolean?, issuerMode: IssuerMode_providersOauth2List?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, propertyMappings: kotlin.collections.List<java.util.UUID>?, redirectUris: kotlin.String?, refreshTokenValidity: kotlin.String?, search: kotlin.String?, signingKey: java.util.UUID?, subMode: SubMode_providersOauth2List?) : ApiResponse<PaginatedOAuth2ProviderList?> {
    ...
    fun providersOauth2ListRequestConfig(accessCodeValidity: kotlin.String?, accessTokenValidity: kotlin.String?, application: java.util.UUID?, authorizationFlow: java.util.UUID?, clientId: kotlin.String?, clientType: ClientType_providersOauth2List?, includeClaimsInIdToken: kotlin.Boolean?, issuerMode: IssuerMode_providersOauth2List?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, propertyMappings: kotlin.collections.List<java.util.UUID>?, redirectUris: kotlin.String?, refreshTokenValidity: kotlin.String?, search: kotlin.String?, signingKey: java.util.UUID?, subMode: SubMode_providersOauth2List?) : RequestConfig<Unit> {
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                ...
                if (subMode != null) {
                    put("sub_mode", listOf(subMode.toString()))
                }
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
     ...
     */
     enum class DigestAlgorithm_providersSamlList(val value: kotlin.String) {
     ...
     */
     enum class SignatureAlgorithm_providersSamlList(val value: kotlin.String) {
     ...
     */
     enum class SpBinding_providersSamlList(val value: kotlin.String) {
    ...
    fun providersSamlListRequestConfig(acsUrl: kotlin.String?, assertionValidNotBefore: kotlin.String?, assertionValidNotOnOrAfter: kotlin.String?, audience: kotlin.String?, authenticationFlow: java.util.UUID?, authorizationFlow: java.util.UUID?, backchannelApplication: java.util.UUID?, defaultRelayState: kotlin.String?, digestAlgorithm: DigestAlgorithm_providersSamlList?, isBackchannel: kotlin.Boolean?, issuer: kotlin.String?, name: kotlin.String?, nameIdMapping: java.util.UUID?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, propertyMappings: kotlin.collections.List<java.util.UUID>?, search: kotlin.String?, sessionValidNotOnOrAfter: kotlin.String?, signatureAlgorithm: SignatureAlgorithm_providersSamlList?, signingKp: java.util.UUID?, spBinding: SpBinding_providersSamlList?, verificationKp: java.util.UUID?) : RequestConfig<Unit> {
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                ...
                if (spBinding != null) {
                    put("sp_binding", listOf(spBinding.toString()))
                }
     ...
     */
     enum class ForceBinding_providersSamlMetadataRetrieve(val value: kotlin.String) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun providersSamlMetadataRetrieve(id: kotlin.Int, download: kotlin.Boolean? = null, forceBinding: ForceBinding_providersSamlMetadataRetrieve? = null) : SAMLMetadata {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun providersSamlMetadataRetrieveWithHttpInfo(id: kotlin.Int, download: kotlin.Boolean?, forceBinding: ForceBinding_providersSamlMetadataRetrieve?) : ApiResponse<SAMLMetadata?> {
     ...
     * @return RequestConfig
     */
    fun providersSamlMetadataRetrieveRequestConfig(id: kotlin.Int, download: kotlin.Boolean?, forceBinding: ForceBinding_providersSamlMetadataRetrieve?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (download != null) {
                ...
                if (forceBinding != null) {
                    put("force_binding", listOf(forceBinding.toString()))
                }
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
