...
class PoliciesApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
     enum class ActionPoliciesEventMatcherList(val value: kotlin.String) {
     ...
     * @return RequestConfig
     */
    fun policiesEventMatcherListRequestConfig(action: ActionPoliciesEventMatcherList?, app: kotlin.String?, clientIp: kotlin.String?, created: java.time.OffsetDateTime?, executionLogging: kotlin.Boolean?, lastUpdated: java.time.OffsetDateTime?, model: kotlin.String?, name: kotlin.String?, ordering: kotlin.String?, page: kotlin.Int?, pageSize: kotlin.Int?, policyUuid: java.util.UUID?, search: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (action != null) {
                    put("action", listOf(action.value))
                }
                if (app != null) {
